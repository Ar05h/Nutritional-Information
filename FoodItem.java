public class FoodItem {
   ...
   // Second constructor with parameters to initialize private fields (name, fat, carbs, protein)
   public FoodItem(String foodName, double gramsFat, double gramsCarbs, double gramsProtein) {
      name = foodName;
      fat = gramsFat;
      carbs = gramsCarbs;
